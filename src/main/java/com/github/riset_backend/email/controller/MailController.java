...
public class MailController {
    ...
    public void mail(@RequestParam("email") String email) throws Exception {
        mailService.answerMail(email);
    }

    @PostMapping("/checkCode")
    @ResponseStatus
    @Operation(summary = "code 확인하고, 코드를 회사 자동 등록", description = "코드 확인 후 등록")
    public void checkCodeUser(@RequestParam("code") String code) {
        mailService.checkCompanyCode(code);
    }
